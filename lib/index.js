...
SQLVarDate.prototype.decode = function(data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        ...
        var d = new Date((ret - DateOffset) * TimeCoeff + timezoneOffset * MsPerMinute);
        return d;
    }
...
SQLVarTime.prototype.decode = function(data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        var timezoneOffset = new Date().getTimezoneOffset();
        var d = new Date(Math.floor(ret / 10) + timezoneOffset* MsPerMinute);
        return d;
    }
    return null;
};
...
SQLVarTimeStamp.prototype.decode = function(data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        var timezoneOffset = new Date().getTimezoneOffset();
        var d = new Date((date - DateOffset) * TimeCoeff + Math.floor(time / 10) + timezoneOffset * MsPerMinute);
        return d;
    }
